...
class test02 extends JFrame implements KeyListener, Runnable, MouseListener {
	...
	static ArrayList<Booster_Effect> booster_list = new ArrayList<Booster_Effect>();
	Image explosion;
	Bullet b;
	Charge_Effect ce;
	Bullet_Explosion be;
	...
	public void start() {
		...
		if(player_1_char.equals("warmachine")) {
			ge1 = new GunShot_Effect(player_1_x + player_1_char_img.getWidth(null), player_1_y);
			ge2 = new GunShot_Effect(player_1_x + player_1_char_img.getWidth(null), player_1_y);
		...
		try {
			while (true) {
				if (player_1_char.equals("ironman") && player_1_pierce < 4) {
					...
					booe = new Booster_Effect(-100, -100);
					ironman_sub_list.add(sub);
					booster_list.add(booe);
					player_1_pierce++;
		...
		for (int i = 0; i < p_1_bullet_list.size(); i++) {
			if (p_1_bullet_list.size() != 0) {
				...
				if (player_1_char.equals("warmachine") && b != null) {
					if (b.bullet_type == 0) {
						gun_bullet = tk.getImage("D://images//bullet//bullet"+b.gun_type+"_0.png");
						buffg.drawImage(gun_bullet, b.pos.x, b.pos.y + 20, this);
						b.move4();
					} else if (b.bullet_type == 1) {
						gun_bullet = tk.getImage("D://images//bullet//bullet"+b.gun_type+"_1.png");
						buffg.drawImage(gun_bullet, b.pos.x, b.pos.y + 20, this);
						b.move2();
					} else if (b.bullet_type == 2) {
						gun_bullet = tk.getImage("D://images//bullet//bullet"+b.gun_type+"_2.png");
						buffg.drawImage(gun_bullet, b.pos.x, b.pos.y + 20, this);
						b.move();
					} else if (b.bullet_type == 3) {
						gun_bullet = tk.getImage("D://images//bullet//bullet"+b.gun_type+"_3.png");
						buffg.drawImage(gun_bullet, b.pos.x, b.pos.y + 20, this);
						b.move3();
					} else if (b.bullet_type == 4) {
						gun_bullet = tk.getImage("D://images//bullet//bullet"+b.gun_type+"_4.png");
						buffg.drawImage(gun_bullet, b.pos.x, b.pos.y + 20, this);
						b.move5();
					}
				}
	...
	public void Draw_Ironman_sub() { // 아이언맨 보조무기 그리는 메소드
		if (player_1_char.equals("ironman")) {
			for (int k = 0; k < ironman_sub_list.size(); k++) {
				...
				booe = booster_list.get(k);
				booster = tk.getImage("D://images//booster//booster"+(int)booe.effect_num+".png");
				buffg.drawImage(ironman_sub, sub.pos.x, sub.pos.y, this);
				buffg.drawImage(booster, booe.pos.x - booster.getWidth(null), booe.pos.y, this);
				sub.move(k);
				booe.pos.x = sub.pos.x;
				booe.pos.y = sub.pos.y + 3;
				booe.next_img();
			}
	...
	public void Draw_Charge_effect() {
		if (player_1_right_button == true && player_1_char.equals("ironman")) {
			Image charge;
		...
		} else if(player_2_right_button == true && player_2_char.equals("ironman")) {
			Image charge;
			charge = tk.getImage("D://images//charge//charge" + (int) ce.effect_num + ".png");
			ce.move();
			if (right_beam == false) {
	...
	public void Draw_GunShot_effect() {
		if(player_1_char.equals("warmachine")) {
			if (player_1_left_button == true && ge1 != null) {
				Image gunshot;
			...
			if (player_1_right_button == true && ge2 != null) {
				Image gunshot;
...
class Charge_Effect extends Effect_Class {
	...
	public void move() {
		if(test02.player_1_char.equals("ironman")) {
			...
			pos.x = test02.player_2_x;
			pos.y = test02.player_2_y;		
		}
	}
	...
	public void next_img() {
		if(test02.player_1_char.equals("ironman")) {
			...
			if (test02.player_2_right_button == true && test02.right_beam == false) {
				if (test02.right_button_count < 50) {
					effect_num += 0.1;
				}
				if (test02.right_button_count >= 50) {
...
class Booster_Effect extends Effect_Class {

	Booster_Effect(int x, int y) {
		pos = new Point(x, y);
	}
	public void next_img() {
		effect_num++;
...
class Sub_Thread extends Thread {
	...
	public void BulletProcess() {
		...
		if (t.player_1_left_button == true && t.bullet_count_1 >= t.player_1_as) {
			...
			if (t.player_1_char.equals("ironman")) {
				...
				t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 10, 2, 0);
				t.p_1_bullet_list.add(t.b);
				t.b.special = 4;
				if (t.b.special > 0) {
					t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 10, 1, 0);
					t.p_1_bullet_list.add(t.b);
				}
				if (t.b.special > 1) {
					t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 10, 3, 0);
					t.p_1_bullet_list.add(t.b);
				}
				if (t.b.special > 2) {
					t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 10, 0, 0);
					t.p_1_bullet_list.add(t.b);
				}
				if (t.b.special > 3) {
					t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 10, 4, 0);
					t.p_1_bullet_list.add(t.b);
				}
			}
		}
		if (t.player_1_right_button == true && t.bullet_count_3 >= t.player_1_as && t.player_1_char.equals("warmachine")) {
			t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 20, 2, 1);
			t.p_1_bullet_list.add(t.b);
			t.bullet_count_3 = 0;
			if (t.b.special > 0) {
				t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 20, 1, 1);
				t.p_1_bullet_list.add(t.b);
			}
			if (t.b.special > 1) {
				t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 20, 3, 1);
				t.p_1_bullet_list.add(t.b);
			}
			if (t.b.special > 2) {
				t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 20, 0, 1);
				t.p_1_bullet_list.add(t.b);
			}
			if (t.b.special > 3) {
				t.b = new Bullet(t.player_1_x + t.player_1_char_img.getWidth(null), t.player_1_y - 20, 4, 1);
				t.p_1_bullet_list.add(t.b);
			}
		}
		if (t.dual == true) {
			if (t.player_2_left_button == true && t.bullet_count_2 >= t.player_2_as) {
				...
				if (t.player_2_char.equals("ironman")) {
					...
					t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 10, 2, 0);
					t.p_2_bullet_list.add(t.b);
					t.b.special = 4;
					if (t.b.special > 0) {
						t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 10, 1, 0);
						t.p_2_bullet_list.add(t.b);
					}
					if (t.b.special > 1) {
						t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 10, 3, 0);
						t.p_2_bullet_list.add(t.b);
					}
					if (t.b.special > 2) {
						t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 10, 0, 0);
						t.p_2_bullet_list.add(t.b);
					}
					if (t.b.special > 3) {
						t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 10, 4, 0);
						t.p_2_bullet_list.add(t.b);
					}
				}
			}
			if (t.player_2_right_button == true && t.bullet_count_3 >= t.player_2_as && t.player_2_char.equals("warmachine")) {
				t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 20, 2, 1);
				t.p_2_bullet_list.add(t.b);
				t.bullet_count_3 = 0;
				if (t.b.special > 0) {
					t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 20, 1, 1);
					t.p_2_bullet_list.add(t.b);
				}
				if (t.b.special > 1) {
					t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 20, 3, 1);
					t.p_2_bullet_list.add(t.b);
				}
				if (t.b.special > 2) {
					t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 20, 0, 1);
					t.p_2_bullet_list.add(t.b);
				}
				if (t.b.special > 3) {
					t.b = new Bullet(t.player_2_x + t.player_2_char_img.getWidth(null), t.player_2_y - 20, 4, 1);
					t.p_2_bullet_list.add(t.b);
				}
			}
		}
	...
	public void LaserProcess() {
		if (t.player_1_right_button == true && t.right_beam == false && t.player_1_char.equals("ironman")) {
			t.right_button_count++;
			if (t.right_button_count >= 50) {
				t.player_1_char_img = t.tk.getImage("D://images//laser1.gif");
			}
		} else if(t.player_2_right_button == true && t.right_beam == false && t.player_2_char.equals("ironman")){
			t.right_button_count++;
			if (t.right_button_count >= 50) {
				t.player_2_char_img = t.tk.getImage("D://images//laser1.gif");
			}
		} else {			
	...
	public void Hit_Bullet_Check() { // 캐릭터와 적 미사일 충돌체크 메소드
		if (t.kill_bullet_list.size() != 0) {
			for (int i = 0; i < t.kill_bullet_list.size(); i++) {
				...
				if (Crash(t.player_1_x + 30, t.player_1_y + 17, t.kb.pos.x, t.kb.pos.y, t.player_1_char_img,
						t.kill_bullet, -60, -90)) {
					if (t.kill_bullet_list.size() > 0) {
				...
				if (t.dual == true) {
					if (Crash(t.player_2_x + 30, t.player_2_y + 17, t.kb.pos.x, t.kb.pos.y, t.player_2_char_img,
							t.kill_bullet, -60, -90)) {
						if (t.kill_bullet_list.size() > 0) {
							t.kill_bullet_list.remove(i);
						}
		...
		try {
			for (int v = 0; v < t.item_list.size(); v++) {
				...
				if (Crash(t.player_1_x, t.player_1_y, t.ie.pos.x, t.ie.pos.y, t.player_1_char_img, t.ie.item)) {
					...
					t.ige = new Item_Get_Effect(t.ie.pos.x - t.item_get.getWidth(null) / 2 + 5,
							t.ie.pos.y - t.item_get.getHeight(null) / 2 + 5);
				...
				if (Crash(t.player_2_x, t.player_2_y, t.ie.pos.x, t.ie.pos.y, t.player_2_char_img, t.ie.item)) {
					...
					if (t.player_2_char.equals("ironman") && t.player_2_pierce < 4 && t.ie.item_name.equals("pierce")) {
						if (t.player_2_pierce == 0) {
							...
							t.booe = new Booster_Effect(t.player_2_x - t.ironman_sub.getWidth(null), t.player_2_y);
